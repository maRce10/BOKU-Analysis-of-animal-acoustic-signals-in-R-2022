---
title: <center><font size="7"><b>Measures of acoustic structure</b></font></center>
subtitle: <center><font size="4"><b>Analysis of animal acoustic signals in R</b> <br> BOKU International wildlife lectures, 2022</font></center>
...
<img src="images/Phae.long1.wav-1-dfDTW.jpeg" alt="viewSpec" width="480">
...
Calculate song-level parameters for selecting parameters with 'mean_colm', 'max_colm'
...
- Calculate call level parameters for Spix's disc-winged bat response calls. The extended selection table can be downloaded as follows:

```{r, eval = FALSE}

download.file(url = "https://ndownloader.figshare.com/files/21189891", 
 destfile = "response_calls.RDS")


```


- Compare the calling rate between sex and age classes (could be done visually using `boxplot()`)

- Calculate call level spectrographic parameters (from `spectro_analysis()`)

- Compare the peak frequency between sex and age classes
...
1. Araya-Salas M, A Hernández-Pinsón N RojasΔ, G Chaverri. (2020). [Ontogeny of an interactive call-and-response system in Spix’s disc-winged bats. Animal Behaviour.](https://marceloarayasalas.weebly.com/uploads/2/5/5/2/25524573/ontogeny_of_an_interactive_call-and-response_system_araya-salas_et_al.pdf)

1. Araya-Salas M, Smith-Vidaurre G (2017) [warbleR: An R package to streamline analysis of animal acoustic signals. Methods Ecol Evol 8:184–191.](http://onlinelibrary.wiley.com/doi/10.1111/2041-210X.12624/epdf)

1. Lyon, R. H., & Ordubadi, A. (1982). Use of cepstra in acoustical signal analysis. Journal of Mechanical Design, 104(2), 303-306.

1. Salamon, J., Jacoby, C., & Bello, J. P. (2014). A dataset and taxonomy for urban sound research. In Proceedings of the 22nd ACM international conference on Multimedi. 1041-1044.
