...
<center><img src = "images/response_thyroptera.png" alt = "viewSpec" width = "640"></center>

&nbsp;

An extended selection table with response calls can be downloaded as follows:
```{r, eval = FALSE}

download.file(url = "https://ndownloader.figshare.com/files/21189891", 
 destfile = "./examples/response_calls.RDS")

a <- readRDS("./examples/response_calls.RDS")
